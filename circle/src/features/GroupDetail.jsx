...
import { getGroupById } from "../services/groups/ParseGroupService";
    ...
    <div className="page-wrapper group-detail-page-wrapper">
      <div className="group-detail-layout">
        <div className="group-main-content">
          ...
          <GroupHeader name={group.name} isUserJoined={group.isUserJoined} />
          ...
          {group.posts.map((groupPost, index) => (
            <Post key={index} post={groupPost} isGroupPost={true} />
          ))}
        </div>
